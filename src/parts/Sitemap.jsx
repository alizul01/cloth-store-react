                    ...
                    <div className="flex flex-wrap -mx-4 justify-center">
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                <li>
                                    <NavLink to="/shipping" className="hover:underline py-1 block">
                                        Shipping
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/refund" className="hover:underline py-1 block">
                                        Refund
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/promotion" className="hover:underline py-1 block">
                                        Promotion
                                    </NavLink>
                                </li>
                            </ul>
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                <li>
                                    <NavLink to="/about" className="hover:underline py-1 block">
                                        About
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/career" className="hover:underline py-1 block">
                                        Career
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/contact-us" className="hover:underline py-1 block">
                                        Contact Us
                                    </NavLink>
                                </li>
                            </ul>
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                <li>
                                    <NavLink to="/terms-and-conditions" className="hover:underline py-1 block">
                                        Terms & Conds
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/privacy-policies" className="hover:underline py-1 block">
                                        Privacy Policy
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/developer" className="hover:underline py-1 block">
                                        For Developer
                                    </NavLink>
                                </li>
                            </ul>
